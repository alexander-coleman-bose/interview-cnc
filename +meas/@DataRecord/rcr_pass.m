function out = rcr_pass(dataRecords)
%RCR_PASS Computes and outputs Rcr_pass.
%   Calculate predicted and measured ANR performance from CPSD measurements
%   and digital filter specifications.
%
%   RCR_PASS(DATARECORDS) returns a 1xN array of structs with the fields
...
%   rcr_pass's that can be calculated from the corresponding DataRecord. If
%   there are multiple possible rcr_pass's from a single DataRecord,
