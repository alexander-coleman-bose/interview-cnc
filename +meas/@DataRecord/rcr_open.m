function out = rcr_open(dataRecords)
%RCR_OPEN Computes and outputs Rcr_open.
%   Calculate predicted and measured ANR performance from CPSD measurements
%   and digital filter specifications.
%
%   RCR_OPEN(DATARECORDS) returns a 1xN array of structs with the fields
...
%   rcr_open's that can be calculated from the corresponding DataRecord. If
%   there are multiple possible rcr_open's from a single DataRecord,
...
metricStepType = bose.cnc.meas.StepType.NoiseOpen;
