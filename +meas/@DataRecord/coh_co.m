function out = coh_co(dataRecords)
%COH_CO Computes and outputs coherence.
%   Calculate predicted and measured ANR performance from CPSD measurements
%   and digital filter specifications.
%
%   COH_CO(DATARECORDS) returns a 1xN array of structs with the fields
...
%   coh_co's that can be calculated from the corresponding DataRecord. If
%   there are multiple possible coh_co's from a single DataRecord,
