function out = gcd(dataRecords)
%GCD Computes and outputs Gcd.
%   Calculate predicted and measured ANR performance from CPSD measurements
%   and digital filter specifications.
%
%   GCD(DATARECORDS) returns a 1xN array of structs with the fields
...
%   gcd's that can be calculated from the corresponding DataRecord. If
%   there are multiple possible gcd's from a single DataRecord,
