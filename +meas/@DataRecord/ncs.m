function out = ncs(dataRecords)
%NCS Computes and outputs Ncs.
%   Calculate predicted and measured ANR performance from CPSD measurements
%   and digital filter specifications.
%
%   NCS(DATARECORDS) returns a 1xN array of structs with the fields
...
%   ncs's that can be calculated from the corresponding DataRecord. If
%   there are multiple possible ncs's from a single DataRecord,
