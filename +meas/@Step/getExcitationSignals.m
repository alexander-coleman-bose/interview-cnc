function excitationSignals = getExcitationSignals(obj, signalMask)
    %GETEXCITATIONSIGNALS Generate a typical excitation for this Step.
    %
    ...
    %
    %Usage:
    %   excitationSignals = myStep.getExcitationSignals;
    %   excitationSignals = myStep.getExcitationSignals(signalMask);
    %
    ...
    idHeader = 'bose:cnc:meas:Step:getExcitationSignals:';
